...
var VveGroupCard = ({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    var mapIcoon = /*#__PURE__*/React.createElement("svg", {
      viewBox: "0 0 24 24",
      fill: "none",
      stroke: "currentColor",
      strokeWidth: "1.7",
      ...
      d: "M3.5 7.5a1.5 1.5 0 0 1 1.5-1.5h3.6l1.6 1.8h8.3a1.5 1.5 0 0 1 1.5 1.5v8.2a1.5 1.5 0 0 1-1.5 1.5H5a1.5 1.5 0 0 1-1.5-1.5z"
    }));
    return /*#__PURE__*/React.createElement("div", {
      className: "xl-cell xl-cell-map",
      title: naam + (url ? '\nKlik om de dossiermap te openen' : '\nKlik om de mapnaam te kopi\u00EBren\n(map openen niet beschikbaar: geen dossierlocatie in team_config.js)'),
      onClick: e => url ? e.stopPropagation() : kopieerMapnaam(e, naam)
    }, url ? /*#__PURE__*/React.createElement("a", {
      href: url,
      target: "_blank",
      rel: "noopener noreferrer",
      className: "xl-map-knop",
      "aria-label": "Dossiermap openen",
      onClick: e => e.stopPropagation()
    }, mapIcoon) : /*#__PURE__*/React.createElement("span", {
      className: "xl-map-knop xl-map-knop-kopie"
    }, mapIcoon));
  })(), /*#__PURE__*/React.createElement("div", {
    className: "xl-cell xl-cell-center",
    style: {
...
var App = () => {
  ...
  var xlBaseTemplate = '36px minmax(200px,1fr)' + (MAPNAMEN_AAN ? ' 44px' : '') + ' 52px 52px 108px 52px 76px 68px 80px 72px 34px 34px 34px';
  var xlColTemplate = dossierVisible ? xlBaseTemplate + ' 34px 88px 68px 84px' : xlBaseTemplate;
  var xlMinWidth = (dossierVisible ? 1160 : 874) + (MAPNAMEN_AAN ? 44 : 0);
